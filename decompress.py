...
def output(extension):
    ...
    print("=========================================================")
    print("Found a total of: %d findings." % len(findings))
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output", help="Output the results into a file.", type=str, choices=[".txt", ".json", 
".csv"], default=".json")
